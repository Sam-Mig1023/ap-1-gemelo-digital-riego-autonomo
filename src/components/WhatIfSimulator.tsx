        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-xl space-y-1">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className={`text-xs font-semibold px-2 py-0.5 rounded ${
              ...
              Día {maxStressDay.dayIndex} ({maxStressDay.date})
            </span>
          </div>
        </div>
        ...
        <div className="h-72 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={simulationResults} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              <ReferenceLine y={selectedZone.fieldCapacity * 100} label={{ value: 'Cap. Campo', fill: '#10b981', fontSize: 10 }} stroke="#10b981" strokeDasharray="3 3" />
              <ReferenceLine y={selectedZone.wiltingPoint * 100} label={{ value: 'P. Marchitez', fill: '#ef4444', fontSize: 10 }} stroke="#ef4444" strokeDasharray="3 3" />

              <Line type="monotone" dataKey="moistureTopLayer" name="Humedad Estrato 10cm (%)" stroke="#38bdf8" strokeWidth={2.5} />
              <Line type="monotone" dataKey="moistureDeepLayer" name="Humedad Bulbo 30cm (%)" stroke="#818cf8" strokeWidth={2} />
              <Line type="monotone" dataKey="etcMm" name="ETc Diaria (mm)" stroke="#f59e0b" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </div>
