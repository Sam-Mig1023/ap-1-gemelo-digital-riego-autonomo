    ...
    <div className="space-y-6">
          ...
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-6 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-3 relative">
              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-2.5">
                ...
                <h4 className="text-xs font-bold text-white">Ingestión Multi-Sensor</h4>
              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-2.5">
                ...
                <h4 className="text-xs font-bold text-white">Tensor Fusion & XAI</h4>
                <p className="text-[11px] text-slate-400 leading-relaxed">
              ...
              {/* Stage 3: RL Core */}
              <div className="bg-slate-950 p-4 rounded-xl border border-emerald-500/40 shadow-lg shadow-emerald-950/30 space-y-2.5">
              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-2.5">
                ...
                <h4 className="text-xs font-bold text-white">Controlador VRI</h4>
                <p className="text-[11px] text-slate-400 leading-relaxed">
              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-blue-500/40 space-y-2.5">
                <div className="w-7 h-7 rounded-lg bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold font-mono">
                  05
                </div>
      ...
      {activeSubTab === 'codebase' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 bg-slate-900 border border-slate-800 p-4 rounded-2xl space-y-3 shadow-lg">
            <div className="flex items-center justify-between border-b border-slate-800 pb-2.5">
              <span className="text-xs font-bold text-slate-200 uppercase tracking-wider flex items-center gap-1.5">
                <FileCode className="w-3.5 h-3.5 text-emerald-400" />
                Archivos del Backend
              </span>
              <span className="text-[10px] text-slate-400 font-mono">{filteredFiles.length} archivos</span>
            </div>
          ...
          <div className="lg:col-span-8 bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-2xl flex flex-col">
            ...
            <div className="bg-slate-950 p-3.5 border-b border-slate-800 flex items-center justify-between">
              <div className="flex items-center gap-2 font-mono text-xs text-slate-300">
                ...
                <span className="text-[10px] text-slate-500 bg-slate-800 px-2 py-0.5 rounded uppercase">
      ...
      {activeSubTab === 'er_diagram' && (
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-6 shadow-xl">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            ...
            <span className="text-xs text-slate-400">SRID: 4326 (WGS 84)</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-2">
              ...
              <ul className="text-xs font-mono space-y-1 text-slate-300">
                ...
                <li><span className="text-slate-400">total_area_ha:</span> Float</li>
                <li><span className="text-slate-400">crop_name:</span> String(100)</li>
                <li><span className="text-slate-400">kc_factor:</span> Float</li>
              </ul>
            </div>
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-2">
              ...
              <ul className="text-xs font-mono space-y-1 text-slate-300">
                ...
                <li><span className="text-slate-400">field_capacity:</span> Float</li>
                <li><span className="text-slate-400">wilting_point:</span> Float</li>
              </ul>
            </div>
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-blue-500/40 space-y-2">
              ...
              <ul className="text-xs font-mono space-y-1 text-slate-300">
                ...
                <li><span className="text-slate-400">zone_id:</span> String(36) [Index]</li>
        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-4 shadow-xl">
          ...
          <div className="space-y-2.5 text-xs font-mono">
            {[
              ...
              <div key={i} className="bg-slate-950 p-3 rounded-xl border border-slate-800 flex flex-wrap items-center justify-between gap-2">
